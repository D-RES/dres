...
def pnemo_renewables(county=None, type=""):
    ...
    try:
        ...
        response = requests.post("http://localhost:8008/pnemo/api/renewables/",
        ...
        assert('This localhost test server is offline (http://localhost:8008).')
